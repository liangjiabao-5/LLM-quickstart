...
#运行代码
打开client端  glm(chatglm3_multi) root@dsw-403660-8c4f46d5f-pfgzx:/mnt/workspace/glm3/ChatGLM3-main/openai_api_demo# python api_server.py 
python ai_translator/main.py  --model_type GLMModel
